...
const Navbar = () => {
    ...
    return ( 
        ...
        <style>
            ...
            <div className="navbar h-full w-[15%] bg-zinc-900 flex justify-center items-center outline-none">
                <div className="main-nav h-full w-[100%] bg-zinc-900 flex flex-col py-[10px] ">
                    <div className="nav-head h-[80px] w-full bg-transparent flex justify-start items-center gap-[5px] px-[2vw]">
                        <img src="./image.png" alt="" className="h-[50px] w-[50px]" />
                        <h1 className=" title text-[30px] font-bold text-[#41a3ff]">OASIS</h1>
                    </div>
                    <div className="nav-top h-[25%] w-full bg--500 text-white flex flex-col justify-center items-start gap-[20px] px-[2vw] ">
                        ...
                        <Links title={
                            <div className="flex justify-center items-center gap-[5px]">
                                <IoMdHome size={25} />
                                <h1 className=" title font-semibold">Home</h1>
                            </div>
                        }/>
                        <Links title={
                            <div className="flex justify-center items-center gap-[5px]">
                                <IoMdPeople size={25} />
                                <h1 className=" title font-semibold">Community</h1>
                            </div>
                        }/>
                        <Links title={
                            <div className="flex justify-center items-center gap-[5px]">
                                <MdEvent size={25} />
                                <h1 className=" title font-semibold">Events</h1>
                            </div>
                        }/> 
                    </div>
